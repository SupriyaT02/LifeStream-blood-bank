...
<br>
        <h1 style="text-align:center;font-size:45px;">Welcome to LifeStream blood bank</h1>
<br>
        <div class="row">
...
<br>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
                <a class="btn btn-lg btn-secondary btn-block" href="donate_blood.php" style="text-align:center; background-color:#7FB3D5;color:#273746 ">Become a Donor </a>
            </div>
        </div>
